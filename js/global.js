...
async function getNumberCalc(url, dataValue, valueName) {
  // SIMULAÇÃO: Ignora a chamada real e retorna um valor fixo
  // Você pode personalizar o valor retornado conforme necessário
  const data = { getNumberByName: 7 };
  if (valueName) {
    console.log("[SIMULADO] result: " + data[valueName]);
